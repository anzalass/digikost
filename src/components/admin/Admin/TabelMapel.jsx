...
export default function TabelMapel({ data, children }) {
    ...
    const ajukanIzin = async (e) => {
        e.preventDefault();
        try {
            const tambah = await axios.post(`${BACKEND_BASE_URL}/api/requestIzin`, izin);
    ...
    const EditIzin = async () => {
        try {
            const res = await axios.put(`${BACKEND_BASE_URL}/api/EditIzin/${idIzin}`, izinEdit);
            if (res.status === 200) {
                window.location.reload()
            }
        } catch (err) {
        ...
        <>
            <div className="bg-white w-[96%] mt-3  mb-[200px]  mx-auto p-3 rounded-lg">
                ...
                {pengadaanBarang ? (
                    <div className="w-[95%] mx-auto h-[130vh] bg-white rounded-xl">
                        <div action="" className="w-[95%] mx-auto mt-2 p-3">
                            <button type="button" onClick={() => setIzin({ ...izin, typeIzin: 'Tidak Masuk' })} className={izin.typeIzin == "Tidak Masuk" ? "text-white bg-blue-700 hover:bg-blue-800 focus:ring-4 focus:ring-blue-300 font-medium rounded-lg text-sm px-5 py-2.5 mr-2 mb-2 dark:bg-blue-600 dark:hover:bg-blue-700 focus:outline-none dark:focus:ring-blue-800" : "py-2.5 px-5 mr-2 mb-2 text-sm font-medium text-gray-900 focus:outline-none bg-white rounded-lg border border-gray-200 hover:bg-gray-100 hover:text-blue-700 focus:z-10 focus:ring-4 focus:ring-gray-200 dark:focus:ring-gray-700 dark:bg-gray-800 dark:text-gray-400 dark:border-gray-600 dark:hover:text-white dark:hover:bg-gray-700"}>Izin Tidak Masuk</button>
                            <button type="button" onClick={() => setIzin({ ...izin, typeIzin: 'Keluar' })} className={izin.typeIzin == "Keluar" ? "text-white bg-blue-700 hover:bg-blue-800 focus:ring-4 focus:ring-blue-300 font-medium rounded-lg text-sm px-5 py-2.5 mr-2 mb-2 dark:bg-blue-600 dark:hover:bg-blue-700 focus:outline-none dark:focus:ring-blue-800" : "py-2.5 px-5 mr-2 mb-2 text-sm font-medium text-gray-900 focus:outline-none bg-white rounded-lg border border-gray-200 hover:bg-gray-100 hover:text-blue-700 focus:z-10 focus:ring-4 focus:ring-gray-200 dark:focus:ring-gray-700 dark:bg-gray-800 dark:text-gray-400 dark:border-gray-600 dark:hover:text-white dark:hover:bg-gray-700"}>Izin Keluar</button>
                            <button type="button" onClick={() => setIzin({ ...izin, typeIzin: 'Pulang' })} className={izin.typeIzin == "Pulang" ? "text-white bg-blue-700 hover:bg-blue-800 focus:ring-4 focus:ring-blue-300 font-medium rounded-lg text-sm px-5 py-2.5 mr-2 mb-2 dark:bg-blue-600 dark:hover:bg-blue-700 focus:outline-none dark:focus:ring-blue-800" : "py-2.5 px-5 mr-2 mb-2 text-sm font-medium text-gray-900 focus:outline-none bg-white rounded-lg border border-gray-200 hover:bg-gray-100 hover:text-blue-700 focus:z-10 focus:ring-4 focus:ring-gray-200 dark:focus:ring-gray-700 dark:bg-gray-800 dark:text-gray-400 dark:border-gray-600 dark:hover:text-white dark:hover:bg-gray-700"}>Izin Pulang</button>
                            ...
                            <div className="w-full mt-4">
                                <textarea name="keterangan" onChange={(e) => changeIzinHandler(e)} id="comment" rows="4" class="w-full px-0 text-sm text-gray-900 bg-white border-0 dark:bg-gray-800 focus:ring-0 dark:text-white dark:placeholder-gray-400" placeholder="Keterangan" required></textarea>
                            </div>
                ...
                {editBarang ? (
                    <div className="w-[95%] mx-auto h-[130vh] bg-white rounded-xl">
                        <div action="" className="w-[95%] mx-auto mt-2 p-3">
                            <button type="button" onClick={() => typeIzinChange("TidakMasuk")} className={izinEdit.typeIzin == "Tidak Masuk" ? "text-white bg-blue-700 hover:bg-blue-800 focus:ring-4 focus:ring-blue-300 font-medium rounded-lg text-sm px-5 py-2.5 mr-2 mb-2 dark:bg-blue-600 dark:hover:bg-blue-700 focus:outline-none dark:focus:ring-blue-800" : "py-2.5 px-5 mr-2 mb-2 text-sm font-medium text-gray-900 focus:outline-none bg-white rounded-lg border border-gray-200 hover:bg-gray-100 hover:text-blue-700 focus:z-10 focus:ring-4 focus:ring-gray-200 dark:focus:ring-gray-700 dark:bg-gray-800 dark:text-gray-400 dark:border-gray-600 dark:hover:text-white dark:hover:bg-gray-700"}>Izin Tidak Masuk</button>
                            <button type="button" onClick={() => typeIzinChange("Keluar")} className={izinEdit.typeIzin == "Keluar" ? "text-white bg-blue-700 hover:bg-blue-800 focus:ring-4 focus:ring-blue-300 font-medium rounded-lg text-sm px-5 py-2.5 mr-2 mb-2 dark:bg-blue-600 dark:hover:bg-blue-700 focus:outline-none dark:focus:ring-blue-800" : "py-2.5 px-5 mr-2 mb-2 text-sm font-medium text-gray-900 focus:outline-none bg-white rounded-lg border border-gray-200 hover:bg-gray-100 hover:text-blue-700 focus:z-10 focus:ring-4 focus:ring-gray-200 dark:focus:ring-gray-700 dark:bg-gray-800 dark:text-gray-400 dark:border-gray-600 dark:hover:text-white dark:hover:bg-gray-700"}>Izin Keluar</button>
                            <button type="button" onClick={() => typeIzinChange("Pulang")} className={izinEdit.typeIzin == "Pulang" ? "text-white bg-blue-700 hover:bg-blue-800 focus:ring-4 focus:ring-blue-300 font-medium rounded-lg text-sm px-5 py-2.5 mr-2 mb-2 dark:bg-blue-600 dark:hover:bg-blue-700 focus:outline-none dark:focus:ring-blue-800" : "py-2.5 px-5 mr-2 mb-2 text-sm font-medium text-gray-900 focus:outline-none bg-white rounded-lg border border-gray-200 hover:bg-gray-100 hover:text-blue-700 focus:z-10 focus:ring-4 focus:ring-gray-200 dark:focus:ring-gray-700 dark:bg-gray-800 dark:text-gray-400 dark:border-gray-600 dark:hover:text-white dark:hover:bg-gray-700"}>Izin Pulang</button>
                            <div className="w-full mt-4">
                                <h1 className="font-abc pb-2 ">Mata Pelajaran</h1>
                                <select
                                    name="idMapel"
